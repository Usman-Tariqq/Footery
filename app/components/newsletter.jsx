...
const newsletter = () => {
  return (
    <div className="flex flex-col justify-center items-center rounded-md w-full mb-10">
      <h1 className="font-bold text-2xl md:text-3xl mt-10 text-black">
        Sign up for our newsletter
      </h1>
      <p className="w-96 sm:w-[550px] lg:w-1/2 text-lg md:text-2xl mt-4 ml-5 px-5 text-black">
      ...
      <div className="flex justify-center items-center mt-4">
        <form>
          <input
            className="text-black w-64 md:w-[530px] indent-4 rounded-l p-1"
            type="email"
            name="name"
      ...
      <p className="mx-4 md:text-xl text-black">
